...
## P0
- [ ] Small watch screens: layout feels too large and cramped on small Apple Watch sizes; brick height scaling looks off. (Scaling pass implemented; needs device validation.)
...
- [ ] Difficulty settings: add easy/medium/hard modes and tune parameters per mode.
